...
render(){
    ...
    return(
        ...
        <div className='col-md-6'>
            ...
            <Projectname>Finally Machine learning! <em style={{"fontSize":"1.0em", "fontWeight":"500"}}></em></Projectname>
            </Underline>
                ...
                <Matter>The main goal is to build a machine learning (ML) classifier to efficiently perform the task of 
                    ...
                    polluter or not. Built in Python and no ML packages are used.
                </Matter>
            ...
            <Underline className='col-md-12 underline'>
            <Projectname>Event Extractions <em style={{"fontSize":"1.0em", "fontWeight":"500"}}></em></Projectname>
            </Underline>
            
                <Matter>Built an information extraction(IE) system for the news articles as part of the Natural Language 
                    ...
                    which does any means of event extractions are used. Awarded the best poster for the final project presentation.
                </Matter>
            ...
            <Projectname>Building Visualization tools</Projectname>
                ...
                <Matter>I'm happy with the opportunities I have been getting in the recent past for building
                    ...
                    with <em>ReactJS</em>. Used <em>ReactJS + ExpressJS</em> for building this website as well.
                </Matter>
            ...
            <Projectname>My first ever interactive webpage</Projectname>
                ...
                <Matter>Worked on this as a part of Data Visualization course I have taken
            ...
            <Projectname>Deep into Databases</Projectname>
                ...
                <Matter>Worked on this as a part of Advanced Database Systems course and 
